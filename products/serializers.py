...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = [
            'id', 'name', 'product_image', 'category', 'used_for', 
            'description', 'price', 'discount', 'sku', 
            'stock_quantity', 'product_ref', 'created_at', 'discounted_price'
            , 'additional_info'
        ]
...
class ProductCreateUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = [
            'name', 'product_image', 'category', 'used_for', 
            'description', 'price', 'discount', 'sku', 
            'stock_quantity', 'additional_info'
        ]
